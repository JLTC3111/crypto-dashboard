...
def get_icon(icon_name: str, library: str = "lucide", size: int = 16, color: str = "#666666") -> str:
    ...
    icons = {
        "lucide": {
            "unique": f'''<svg height="{size}" width="{size}" version="1.1" xmlns="http://www.w3.org/2000/svg" 
                         viewBox="0 0 512 512" xml:space="preserve" fill="{color}">
                         <path d="M406.014,87.606c-34.412-19.714-78.033-31.809-124.787-35.051V14.451C281.227,6.469,269.931,0,255.996,0
                         ...
                         c26.757-17.17,42.728-46.392,42.728-78.171v-88.486C476.982,150.49,451.779,113.818,406.014,87.606z
                         M255.996,172.246c13.935,0,25.231-6.469,25.231-14.45V134.36c25.558,5.764,43.665,19.997,43.665,36.687
                         c0,21.792-30.842,39.464-68.896,39.464c-38.046,0-68.888-17.672-68.888-39.464c0-16.682,18.107-30.915,43.658-36.687v23.435
                         ...
                         c19.626,18.478,46.398,33.314,77.836,43.68c31.446,10.358,67.602,16.202,106.084,16.202
                         c58.654-0.029,111.87-13.513,151.29-36.054c15.737-9.021,29.251-19.532,39.98-31.381V279.348z
                         M447.266,207.05c-4.121,11.318-11.725,22.388-22.629,32.667c-16.522,15.606-40.532,29.199-69.52,38.729
                         c-28.989,9.552-62.899,15.091-99.12,15.091c-55.186,0.029-105.03-12.917-140.212-33.11
                         ...
                         c93.705,7.073,166.039,52.977,166.039,108.585V207.05z"></path>
                         </svg>''',
            "lowBattery": f'''<svg width="{size}" height="{size}" viewBox="-0.5 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                             <path d="M17.65 17H3C2.72 17 2.5 16.78 2.5 16.5V8.5C2.5 8.22 2.72 8 3 8H17.65C17.93 8 18.15 8.22 18.15 8.5V16.5C18.15 16.78 17.92 17 17.65 17Z" 
                                   stroke="#0F0F0F" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                             <path d="M20.38 10.81H21C21.28 10.81 21.5 11.03 21.5 11.31V13.69C21.5 13.97 21.28 14.19 21 14.19H20.38" 
                                   stroke="#0F0F0F" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                             <path d="M4.72998 10.25V14.75" stroke="#0F0F0F" stroke-miterlimit="10" stroke-linecap="round"></path>
                             </svg>''',
            "bullseye": f'''<svg fill="#000000" style="transform:translateY(-3px)" height="16px" width="16px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" 
            xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512.016 512.016" xml:space="preserve"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" 
            stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g> <path d="M431.537,348.296C480.252,313.471,512.01,256.444,512.01,192c0-106.033-85.967-192-192-192 
            c-98.82,0-180.199,74.674-190.814,170.667h-9.335l-15.437-30.874c-5.269-10.538-18.083-14.81-28.622-9.541 s-14.81,18.083-9.541,28.622l5.896,11.793H55.862l-15.437-30.874c-5.269-10.538-18.083-14.81-28.622-9.541 
            s-14.81,18.083-9.541,28.622L18.826,192L2.263,225.126c-5.269,10.538-0.998,23.353,9.541,28.622s23.353,0.998,28.622-9.541 l15.437-30.874h16.297l-5.896,11.793c-5.269,10.538-0.998,23.353,9.541,28.622s23.353,0.998,28.622-9.541l15.437-30.874h9.335
            c6.148,55.594,36.024,104.035,79.287,134.963l-57.411,133.979c-4.641,10.83,0.377,23.371,11.206,28.011 c10.83,4.641,23.371-0.377,28.011-11.206l55.661-129.894C268.742,378.724,293.76,384,320.01,384 c26.251,0,51.268-5.276,74.059-14.814l55.661,129.894c4.641,10.83,17.182,15.847,28.011,11.206 c10.83-4.641,15.847-17.182,11.206-28.011L431.537,348.296z M172.201,213.333h43.285c9.903,48.646,52.986,85.333,104.525,85.333
            c58.843,0,106.667-47.823,106.667-106.667S378.854,85.333,320.01,85.333c-51.539,0-94.622,36.688-104.525,85.333h-43.285 c10.354-72.363,72.585-128,147.809-128c82.469,0,149.333,66.865,149.333,149.333S402.479,341.333,320.01,341.333
            C244.786,341.333,182.555,285.696,172.201,213.333z M320.01,170.667h-60.328C268.493,145.841,292.209,128,320.01,128 c35.279,0,64,28.721,64,64s-28.721,64-64,64c-27.801,0-51.518-17.841-60.328-42.667h60.328c11.782,0,21.333-9.551,21.333-21.333
            S331.792,170.667,320.01,170.667z"></path> </g> </g> </g></svg>''',
            "money": f'''<svg width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.7255 17.1019C11.6265 16.8844 11.4215 16.7257 11.1734 16.6975C10.9633 16.6735 10.7576 16.6285 10.562 16.5636
                                 C10.4743 16.5341 10.392 16.5019 10.3158 16.4674L10.4424 16.1223C10.5318 16.1622 10.6239 16.1987 10.7182 16.2317
                                 L10.7221 16.2331L10.7261 16.2344C11.0287 16.3344 11.3265 16.3851 11.611 16.3851C11.8967 16.3851 12.1038 16.3468 
                                 12.2629 16.2647L12.2724 16.2598L12.2817 16.2544C12.5227 16.1161 12.661 15.8784 12.661 15.6021C12.661 15.2955 
                                 12.4956 15.041 12.2071 14.9035C12.062 14.8329 11.8559 14.7655 11.559 14.6917" fill="#ffffff"/>
                        <path d="M11.9785 18H11.497C11.3893 18 11.302 17.9105 11.302 17.8V17.3985C11.302 17.2929 11.2219 17.2061 11.1195 17.1944
                                 C10.8757 17.1667 10.6399 17.115 10.412 17.0394C10.1906 16.9648 9.99879 16.8764 9.83657 16.7739" fill="#ffffff"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" 
                              d="M9.59235 5H13.8141C14.8954 5 14.3016 6.664 13.8638 7.679L13.3656 8.843L13.2983 9C13.7702 8.97651 14.2369 9.11054 
                                 14.6282 9.382C16.0921 10.7558 17.2802 12.4098 18.1256 14.251C18.455 14.9318 18.5857 15.6958 18.5019 16.451
                                 C18.4013 18.3759 16.8956 19.9098 15.0182 20H8.38823C6.51033 19.9125 5.0024 18.3802 4.89968 16.455" 
        ...
        "heroicons": {
            ...
            "chart": f'''<svg width="{size}" height="{size}" viewBox="0 0 24 24" fill="{color}">
                        ...
                        <path d="M9.75 8.625c0-1.036.84-1.875 1.875-1.875h.75c1.036 0 1.875.84 1.875 1.875v11.25
                                 c0 1.035-.84 1.875-1.875 1.875h-.75a1.875 1.875 0 01-1.875-1.875V8.625z"/>
                        <path d="M3 13.125c0-1.036.84-1.875 1.875-1.875h.75c1.036 0 1.875.84 1.875 1.875v6.75
                                 c0 1.035-.84 1.875-1.875 1.875h-.75A1.875 1.875 0 013 19.875v-6.75z"/>
                        </svg>''',
            "trending-up": f'''<svg width="{size}" height="{size}" viewBox="0 0 24 24" fill="{color}">
                              <path fill-rule="evenodd" d="M15.22 6.268a.75.75 0 01.968-.432l5.942 2.28a.75.75 0 01.431.97l-2.28 5.941
                                                          a.75.75 0 11-1.4-.537l1.63-4.251-1.086.483a11.2 11.2 0 00-5.45 5.174.75.75 0 01-1.199.24
                                                          a9.75 9.75 0 017.04-9.91l.386-.162-4.251-1.631a.75.75 0 01-.432-.968z" clip-rule="evenodd"/>
                              <path fill-rule="evenodd" d="M6.737 11.061a.75.75 0 01.976-.43l4.5 1.746a.75.75 0 01.43.976l-1.746 4.5
                                                          a.75.75 0 11-1.405-.546l1.263-3.25a7.5 7.5 0 00-3.483 3.483.75.75 0 11-1.456-.364
                                                          a9 9 0 014.195-4.195l-3.25-1.263a.75.75 0 01-.431-.976z" clip-rule="evenodd"/>
                              </svg>''',
        }
    }
            ...
            with action_tab3:
                ...
                with col2:
                    ...
                    if not portfolio_df.empty:
                        # Filter out NaN and infinite values for best/worst performer calculations
                        valid_performance_df = portfolio_df[
                            portfolio_df['Percentage_Change'].notna() & 
                            portfolio_df['Percentage_Change'].apply(lambda x: math.isfinite(x) if pd.notna(x) else False)
                        ].copy()
                        ...
                        stats = {
                            ...
                            'best_performer': valid_performance_df.loc[valid_performance_df['Percentage_Change'].idxmax(), 'Symbol'] if not valid_performance_df.empty else 'N/A',
                            'worst_performer': valid_performance_df.loc[valid_performance_df['Percentage_Change'].idxmin(), 'Symbol'] if not valid_performance_df.empty else 'N/A',
