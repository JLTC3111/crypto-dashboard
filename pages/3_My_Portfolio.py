...
def get_icon(icon_name: str, library: str = "lucide", size: int = 16, color: str = "#666666") -> str:
    ...
    icons = {
        "lucide": {
            ...
            "bullseye": f'''<svg width="{size}" height="{size}" viewBox="0 0 73 73" xmlns="http://www.w3.org/2000/svg" fill="none">
                           <g fill-rule="nonzero">
                             <rect x="-1" y="-1" width="71" height="71" rx="14" fill="#FFFFFF" stroke="#1F2F3B" stroke-width="2"></rect>
                             <path d="M48.3750352,23.7374297 L51.7500352,23.7374297 C50.2875,12.4873945 41.3999648,3.59996484 30.2624648,2.13753516 
                                      L30.2624648,5.51253516 C39.6000352,6.97507031 47.0249297,14.3999648 48.3750352,23.7374297 Z 
                                      M30.2625703,48.3750352 L30.2625703,51.7500352 C41.4000703,50.2875 50.4001406,41.3999648 51.7501406,30.2624648 
                                      L48.3751406,30.2624648 C47.0249297,39.6000352 39.6000352,47.0249297 30.2625703,48.3750352 Z" 
                                   fill="#CDD6E0"></path>
                             <polygon fill="#40596B" points="54 25.4250352 28.5749648 25.4250352 28.5749648 0 25.4250352 0 25.4250352 25.4250352 0 25.4250352 0 28.5749648 25.4250352 28.5749648 25.4250352 54 28.5749648 54 28.5749648 28.5749648 54 28.5749648"></polygon>
                             <circle fill="#FF7058" cx="27.0005273" cy="27.0005273" r="5.7375"></circle>
                           </g>
                           </svg>''',
